    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_name_change.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success) {
                                ...
                                Intent intent = new Intent(MyPageUserInfoChangeActivity.this, MyPageSettingActivity.class);
                                startActivity(intent);
                                finish();                            }
                ...
                RequestQueue requestQueue = Volley.newRequestQueue(MyPageUserInfoChangeActivity.this);
