...
public class SellerProductRegisterRequestActivity extends AppCompatActivity {
    ...
    public void showAlert(String message) {
        AlertDialog.Builder builder = new AlertDialog.Builder(SellerProductRegisterRequestActivity.this);
    ...
    private void detailedProductRegisterRequest(String productName, String color1, String color2, String size_s, String size_m, String size_l) {
        ...
        SellerDetailedProductRegisterRequest sellerDetailedProductRegisterRequest = new SellerDetailedProductRegisterRequest(
        ...
        RequestQueue queue = Volley.newRequestQueue(SellerProductRegisterRequestActivity.this);
    ...
    private void productRegisterRequest(String productName, int categoryId, int detailedCategory, int productPrice, String allowance, String sellerId, String mainImage, String detailedImage1, String detailedImage2, String detailedImage3, String sizeImage) {
        ...
        SellerProductRegisterRequest sellerProductRegisterRequest = new SellerProductRegisterRequest(
