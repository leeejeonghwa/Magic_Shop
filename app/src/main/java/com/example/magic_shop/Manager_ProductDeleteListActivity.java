...
public class Manager_ProductDeleteListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.manager_activity_product_delete);
    ...
    public class ProductDeleteItem {
        ...
        public ProductDeleteItem(String date, String productName, String productSize, String productQuantify) {
            this.date = date;
                ...
                productRegisterButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (position != RecyclerView.NO_POSITION) {
                            ...
                            intent.putExtra("date", productDeleteItem.date);
                            intent.putExtra("productName", productDeleteItem.productName);
                            intent.putExtra("trackingNumber", productDeleteItem.productSize);
                            intent.putExtra("trackingNumber", productDeleteItem.productQuantify);
