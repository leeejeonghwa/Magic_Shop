...
public class ManagerProductRegisterListActivity extends AppCompatActivity {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Toast.makeText(ManagerProductRegisterListActivity.this, response, Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(ManagerProductRegisterListActivity.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }) {
            @Override
    ...
    public class ProductUnregisteredAdapter extends RecyclerView.Adapter<ProductUnregisteredAdapter.ProductUnregisteredViewHolder> {
        ...
        public class ProductUnregisteredViewHolder extends RecyclerView.ViewHolder {
            ...
            void bind(ProductItem productItem) {
                ...
                sellerNameTextView.setText(productItem.brandName);
