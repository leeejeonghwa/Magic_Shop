...
public class DetailPageMainOptionSelectCompleteActivity extends AppCompatActivity {
    ...
    private TextView productNameTextView, productPriceTextView, brandNameTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            brandNameTextView = findViewById(R.id.text_brandName);
        ...
        btnBasket.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AddBasketRequest addToBasketRequest = new AddBasketRequest(userID, productID, productOption,
                            ...
                            public void onResponse(String response) {
                                try {
                                    ...
                                    if (success) {
                                        ...
                                        Toast.makeText(DetailPageMainOptionSelectCompleteActivity.this, "장바구니에 저장되었습니다.", Toast.LENGTH_SHORT).show();
                                        Intent intent = new Intent(DetailPageMainOptionSelectCompleteActivity.this, ShoppingBasketActivity.class);
                                        startActivity(intent);

                                    }
                                    else {
                                        Toast.makeText(DetailPageMainOptionSelectCompleteActivity.this, "장바구니에 저장 실패: 서버 응답에 success가 false입니다.", Toast.LENGTH_SHORT).show();

                                    }
                                } catch (JSONException e) {
                                    e.printStackTrace();
                                    Toast.makeText(DetailPageMainOptionSelectCompleteActivity.this, "장바구니에 저장 실패: 서버 응답을 파싱하는 중 오류가 발생했습니다.", Toast.LENGTH_SHORT).show();
                                }
                            }
                        },
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError error) {
                                ...
                                Toast.makeText(DetailPageMainOptionSelectCompleteActivity.this, "장바구니에 추가 중 오류가 발생했습니다.", Toast.LENGTH_SHORT).show();
                            }
                        });

                // Volley RequestQueue에 요청 추가
                RequestQueue queue = Volley.newRequestQueue(DetailPageMainOptionSelectCompleteActivity.this);
