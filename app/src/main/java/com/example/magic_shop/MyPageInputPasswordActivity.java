            ...
            public void onClick(View view) {
                ...
                if (sessionManager != null) {
                    ...
                    if (pass.equals(userPassword)) {
                        Intent intent = new Intent(MyPageInputPasswordActivity.this, MyPageUserInfoChangeActivity.class);
                        startActivity(intent);
                        finish();

                    } else {
                        // 기존 비밀번호 확인 실패
                        Toast.makeText(MyPageInputPasswordActivity.this, "기존 비밀번호가 일치하지 않습니다.", Toast.LENGTH_SHORT).show();
                    }
                } else {
