...
public class SellerRefundListActivity extends AppCompatActivity {
...
//            editTextDeliveryAddressRequest.setText(deliveryRequest);
    ...
    private void approveRefund(String refundID, String orderID, String sellerID, String productID, String userID) {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (success) {
                        ...
                        // 리사이클러뷰 어댑터 갱신
                        getSellerRefundData(userID, SellerRefundListActivity.this);
                    } else {
        ...
        try {
            ...
            RequestQueue queue = Volley.newRequestQueue(SellerRefundListActivity.this);
