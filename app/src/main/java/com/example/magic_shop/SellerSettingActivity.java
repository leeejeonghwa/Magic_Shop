...
public class SellerSettingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_user_info.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), SellerInputPasswordActivity.class);
                startActivity(intent);
            }
        });
        ...
        btn_change_password.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), SellerChangePasswordActivity.class);
                startActivity(intent);
            }
        });
        ...
        btn_refund_account_manage.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), SellerRefundAccountManageActivity.class);
                startActivity(intent);
            }
        });
        ...
        LoginRequest loginRequest = new LoginRequest(SellerSettingActivity.this, userID, userPassword, responseListener);
        RequestQueue queue = Volley.newRequestQueue(SellerSettingActivity.this);
