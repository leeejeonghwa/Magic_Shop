...
public class EditDeliveryAddressRequest extends StringRequest {

    final static private String URL = "http://210.117.175.207:8976/deliveryAddressEdit.php";
    private final Map<String, String> map;

    public EditDeliveryAddressRequest(String userID, String addressID, String deliveryAddressName, String recipient,
