...
public class Seller_RefundExchangeListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.seller_activity_refund_exchange_list);
        ...
        RecyclerView recyclerView = findViewById(R.id.seller_refund_exchange_recyclerView);
        LinearLayoutManager layoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(layoutManager);

        List<RefundExchangeItem> refundExchangeList = getRefundExchangeList();
    ...
    public class RefundExchangeAdapter extends RecyclerView.Adapter<RefundExchangeAdapter.RefundExchangeViewHolder> {
        ...
        public RefundExchangeViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            View view = LayoutInflater.from(context).inflate(R.layout.seller_item_refund_exchange, parent, false);
