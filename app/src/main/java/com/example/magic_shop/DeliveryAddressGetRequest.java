...
public class DeliveryAddressGetRequest extends StringRequest {
    ...
    public DeliveryAddressGetRequest(Context context, String userID, Response.Listener<String> listener) {
