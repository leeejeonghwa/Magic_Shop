...
public class MyPageAnswerListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GetAnswerRequest answerGetRequest = new GetAnswerRequest(MyPageAnswerListActivity.this, userID, responseListener);
        RequestQueue queue = Volley.newRequestQueue(MyPageAnswerListActivity.this);
