...
public class PlusReviewRequest extends StringRequest {

    final static private String URL = "http://210.117.175.207:8976/reviewPlus.php";
    private final Map<String, String> map;

    public PlusReviewRequest(String orderID, String brandName, String productID, String userID, String content,
