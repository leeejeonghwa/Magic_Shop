...
public class SellerProductReviseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_product_revise_request_list.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), SellerProductReviseRequestListActivity.class);
                ...
                productReviseButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (position != RecyclerView.NO_POSITION) {
                            // 다음 화면으로 이동하는 코드
                            ProductItem productItem = productReviseList.get(position);
                            Intent intent = new Intent(context, SellerProductReviseRequestActivity.class);
